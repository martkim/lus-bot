...
@router.post("/api/students", response_model=StudentCreateResponse, dependencies=[Depends(verify_teacher_auth)])
...
@router.delete("/api/admin/students/{student_id}", response_model=MessageResponse, dependencies=[Depends(verify_teacher_auth)])
